...
###SMB options###
set pipename "srvsvc##";
set pipename_stager "SearchTextHarvester##";
...
post-ex {
    ...
    set spawnto_x86 "%windir%\\syswow64\\wininit.exe";
    set spawnto_x64 "%windir%\\sysnative\\wininit.exe";
